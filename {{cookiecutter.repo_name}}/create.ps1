...
if ($CREATE_NOTEBOOK) {
    ...
    $CREATE_NOTEBOOK_CMD = "CREATE OR REPLACE NOTEBOOK DEV_GR_AI_DB.$REPO_NAME.$NOTEBOOK_NAME FROM '$FULL_REPO_PATH' MAIN_FILE = '$NOTEBOOK_NAME.ipynb' QUERY_WAREHOUSE = NPRD_GR_TRANSFORM_WH;"
